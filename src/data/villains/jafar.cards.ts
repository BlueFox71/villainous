...
export const jafarCards: CardDef[] = [
  ...
  },
  {
    ...
    image: img('lampe-merveilleuse.png'),
    playOnlyAt: 'caverne',
  ...
  },
  {
    ...
    image: img('sacrifice-necessaire.png'),
