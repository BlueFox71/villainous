...
export const bowserCards: CardDef[] = [
  ...
  // --- Événements ----------------------------------------------------------
  {
    ...
    image: img('puissance-stellaire.png'),
