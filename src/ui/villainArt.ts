...
> = {
  ...
  imposteur: { scale: 0.55, dxPct: 0, dyPct: -5, versusDyPct: -12, selectScale: 0.57, selectDxPct: 11, loaderPawnScale: 1.49 },
  ...
  // vers le bas).
  gothel: { scale: 1.05, dyPct: 10, versusDyPct: 8, selectScale: 1.12, selectDxPct: 15, loaderPawnScale: 1.48 },
  // Le Seigneur des clés (custom) : on baisse légèrement sa position (sans le rétrécir).
  'custom-seigneur-cles': { dyPct: 6, selectScale: 1.54, selectDxPct: 9, selectDyPct: 2, selectMirror: true, loaderPawnScale: 1.99 },
  // Maléfique : nouvelle illustration carrée (1000×1000) — on la remonte pour caler la
  // figure dans le cadre (négatif = vers le haut).
  maleficent: { dyPct: -6, selectScale: 1.17, selectDxPct: 25, loaderPawnScale: 2.12 },
  ...
  'custom-pyramid-head': { dxPct: -14, versusDxPct: 15, selectScale: 0.86, selectDxPct: 26, selectDyPct: 28, loaderPawnScale: 1.93 },
  ...
  'custom-mr-monopoly': { scale: 0.85, dxPct: -30, versusDxPct: 15, selectScale: 0.6, selectDxPct: 23, selectDyPct: 4, loaderPawnScale: 1.39 },
  // Isabella (custom) : illustration un peu trop grande → légèrement rétrécie.
  'custom-isabella': { scale: 0.9, selectScale: 0.55, selectDxPct: 13, loaderPawnScale: 1.6 },
  princeJohn: { selectScale: 1.22, selectDxPct: 10, selectDyPct: 6, loaderPawnScale: 1.61 },
  bowser: { selectScale: 1.14, selectDxPct: 15, selectDyPct: 8, loaderPawnScale: 1.71 },
  crochet: { selectScale: 1.24, selectDxPct: 10, selectDyPct: 5, selectMirror: true, loaderPawnScale: 1.85 },
  cruella: { selectScale: 1.13, selectDxPct: 19, loaderPawnScale: 1.59, loaderPawnImage: true },
  davyJones: { selectScale: 1.13, selectDxPct: 15, loaderPawnScale: 1.79 },
  'custom-dio': { selectScale: 1.26, selectDxPct: 18, selectDyPct: 65, loaderPawnScale: 1.71 },
  facilier: { selectScale: 1.24, selectDxPct: 17, selectDyPct: 5, loaderPawnScale: 1.38 },
  gaston: { selectScale: 1.06, selectDxPct: 17, loaderPawnScale: 1.4 },
  'custom-stitch': { selectScale: 0.72, selectDxPct: 17, loaderPawnScale: 1.4 },
  'custom-gul-dan': { selectScale: 1.22, selectDxPct: 20, selectDyPct: 26, loaderPawnScale: 1.97 },
  hades: { selectScale: 1.29, selectDxPct: 9, selectDyPct: 7, loaderPawnScale: 1.63 },
  jafar: { selectScale: 1.27, selectDxPct: 17, selectDyPct: 7, loaderPawnScale: 1.97 },
  'custom-killaire': { selectScale: 1.06, selectDxPct: 17, loaderPawnScale: 1.84 },
  mechanteReine: { selectScale: 1.11, selectDxPct: 21, loaderPawnScale: 1.61 },
  'custom-flagelleur-mental': { selectScale: 2, selectDxPct: 35, selectDyPct: 11, selectMirror: true, loaderPawnScale: 1.81 },
  seigneurTenebres: { selectScale: 1.08, selectDxPct: 16, loaderPawnScale: 1.68 },
  lotso: { selectScale: 1.03, selectDxPct: 8, selectDyPct: 5, loaderPawnScale: 1.61 },
  madameTremaine: { selectScale: 1.15, selectDxPct: 17, loaderPawnScale: 1.49 },
  madameMim: { selectScale: 1.03, selectDxPct: 20, loaderPawnScale: 1.59 },
  laBonneFee: { selectScale: 1.13, selectDxPct: 11, selectDyPct: 2, loaderPawnScale: 1.79 },
  'custom-michael-meyers': { selectScale: 0.66, selectDxPct: 19, loaderPawnScale: 1.28 },
  oogieBoogie: { selectScale: 1.09, selectDxPct: 13, loaderPawnScale: 1.73 },
  patHibulaire: { selectScale: 0.96, selectDxPct: 15, loaderPawnScale: 1.26 },
  ratigan: { selectScale: 1.09, selectDxPct: 19, loaderPawnScale: 1.28 },
  reineCoeur: { selectScale: 1.18, selectDxPct: 20, selectDyPct: 5, selectMirror: true, loaderPawnScale: 2.01 },
  saSucrerie: { selectScale: 0.96, selectDxPct: 23, loaderPawnScale: 1.97 },
  scar: { selectScale: 1.04, selectDxPct: 11, loaderPawnScale: 1.55 },
  shereKhan: { selectScale: 1.03, selectDxPct: 20, loaderPawnScale: 1.57 },
  slenderman: { selectScale: 0.95, selectDxPct: 15, selectDyPct: 14, loaderPawnScale: 1.82 },
  sombra: { selectScale: 1.14, selectDxPct: 26, selectDyPct: 4, loaderPawnScale: 1.6 },
  'custom-mrl4fb45': { selectScale: 0.77, selectDxPct: 23, loaderPawnScale: 1.6 },
  syndrome: { selectDxPct: 25, loaderPawnScale: 1.3 },
  tabbou: { selectScale: 1.08, selectDxPct: 20, selectDyPct: 5, loaderPawnScale: 1.51 },
  tamatoa: { selectScale: 0.95, selectDxPct: 19, selectDyPct: 1, loaderPawnScale: 2.26 },
  teamRocket: { selectDxPct: 20, loaderPawnScale: 1.49 },
  thanos: { selectDxPct: 11, selectDyPct: 20, loaderPawnScale: 1.31 },
  'custom-ultron': { selectDxPct: 28, selectDyPct: 9, loaderPawnScale: 1.44 },
  ursula: { selectScale: 1.12, selectDxPct: 17, selectDyPct: 5, selectMirror: true, loaderPawnScale: 1.75 },
  yzma: { selectScale: 0.98, selectDxPct: 19, selectDyPct: 2, loaderPawnScale: 1.69 },
