...
export const PATCH_NOTES: PatchNote[] = [
  {
    version: '0.80',
    date: '2026-06-23',
    title: 'Nouveaux vilains : Sa Sucrerie, Madame Mim, Syndrome & Lotso (+ circuit en huit visuel)',
    changes: [
      ...
      'NOUVEAU VILAIN — Sa Sucrerie (King Candy / Les Mondes de Ralph, Disney, 4★) : mécanique INÉDITE du CIRCUIT EN HUIT. Pas de 4 lieux : un seul circuit de 18 actions où votre pion avance de 1 à 4 cases par tour (au choix) et n’accède qu’à 3 actions à la fois (celle où il est + devant + derrière). Objectif : franchir la case Départ/Arrivée AVANT le jeton Pilote de Vanellope, alors qu’un Bug (Glitch) lui est associé. Faites venir Vanellope dans votre royaume (Fatalité, ou Médaillon des Héros de Ralph + vaincre Ralph la Casse), associez-lui un Bug : la course démarre, vous et le jeton Pilote repartez de Départ/Arrivée.',
